...
class StateTreeManager {
    ...
    async createDeviceObjects(deviceId, deviceInfo) {
        ...
        await this.adapter.setObjectNotExistsAsync(`devices.${deviceId}.hostname`, {
            type: 'state',
            common: {
                name: 'Hostname',
                type: 'string',
        ...
        await this.adapter.setObjectNotExistsAsync(`devices.${deviceId}.ipAddress`, {
            type: 'state',
            common: {
                name: 'IP Address',
                type: 'string',
        ...
        await this.adapter.setObjectNotExistsAsync(`devices.${deviceId}.version`, {
            type: 'state',
            common: {
                name: 'Client Version',
                type: 'string',
        ...
        await this.adapter.setStateAsync(`devices.${deviceId}.hostname`, deviceInfo.hostname || 'unknown', true);
        await this.adapter.setStateAsync(`devices.${deviceId}.ipAddress`, deviceInfo.ipAddress || 'unknown', true);
        await this.adapter.setStateAsync(`devices.${deviceId}.version`, deviceInfo.version || 'unknown', true);
    }
